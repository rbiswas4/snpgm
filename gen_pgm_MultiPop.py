...
pgm.add_node(Node("sigdist", r"$\sigma_{\mathrm{int, A}}^{\mathrm{dist}}, \sigma_{\mathrm{int, B}}^{\mathrm{dist}}, n_A$",
                  2.5, 4, aspect=3.0))
...
# Render and save.
pgm.render()
pgm.figure.savefig("snpgm_MultiPop.png", dpi=150)
